BZFlag Server Plugin: annihilationFlag
================================================================================
...
annihilationFlag directory to a new name, and then manually replace annihilationFlag
...
To load the plugin with specific settings, use the format:
  -loadplugin annihilationFlag,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin annihilationFlag,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin annihilationFlag,<configfilename>
For example:
  -loadplugin annihilationFlag,/path/to/my/sampleplugin.cfg
